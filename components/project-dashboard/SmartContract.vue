  ...
  <b-container fluid>
    <b-row class="mb-3">
      <b-col sm="12" md="8">
        ...
        <b-row>
          <b-col>
            <b-button-toolbar class="my-1" key-nav aria-label="Smart Contract Actions">
              <b-button-group>
                <b-button
      ...
      <b-col sm="12" md="4" class="d-flex flex-column">
        ...
        <div class="d-flex justify-content-between">
          ...
          >
            ...
            <b-dd-item-btn @click="callFuncByName('setSaleStatus', [SALE_STATUS.Paused])">
            ...
            <b-dd-item-btn @click="callFuncByName('setSaleStatus', [SALE_STATUS.Public])">
              <b-icon icon="play-fill" />
        ...
        <b-row class="mb-2">
          <b-col sm="12" md="8" class="d-flex flex-wrap">
            ...
            <b-button
              ...
              class="ml-2"
              variant="outline-primary"
              @click="downloadTextFile(`${rawContract.name}.sol`, rawContract.rawCode)"
...
import { getExplorerUrl, getCurrency, getMainnetConfig } from "@/constants/metamask";
...
export default {
  ...
  computed: {
    ...
    functions() {
      return Object.values(this.contract.interface?.functions || {}).sort((a, b) =>
    ...
    async callFuncByName(name, args = []) {
      try {
        ...
        if (func.constant) {
          ...
          const signedContract = this.contract.connect(this.$wallet.provider.getSigner());

          txResponse = await signedContract[name].call(null, ...args, txOverrides);
