							...
							@change="
								(val) =>
									updateSmartContractBuilder({
										collectionSize: val ? +val : null,
									})
							"
							@blur="$v.smartContractBuilder.collectionSize.$touch()"
							:state="
								validateState('smartContractBuilder.collectionSize')
							"></b-form-input>
				...
				<b-col sm="12" md="6">
					<b-form-group
						...
						<b-form-input
							...
							@change="
								(val) =>
									updateSmartContractBuilder({ mintPrice: val ? +val : null })
							"
							@blur="$v.smartContractBuilder.mintPrice.$touch()"
							:state="
								validateState('smartContractBuilder.mintPrice')
							"></b-form-input>
				...
				<b-col sm="12" md="6">
					<b-form-group
						...
						<b-form-input
							...
							@change="
								(val) =>
									updateSmartContractBuilder({ firstXFree: val ? +val : null })
							"
							@blur="$v.smartContractBuilder.firstXFree.$touch()"
							:state="
								validateState('smartContractBuilder.firstXFree')
							"></b-form-input>
					...
					<b-form-group
						...
						<b-form-input
							...
							@change="
								(val) =>
									updateSmartContractBuilder({
										maxTokensPerTransaction: val ? +val : null,
									})
							"
							@blur="$v.smartContractBuilder.maxTokensPerTransaction.$touch()"
							:state="
								validateState('smartContractBuilder.maxTokensPerTransaction')
							" />
					...
					<b-form-group
						...
						<b-form-input
							...
							@change="
								(val) =>
									updateSmartContractBuilder({
										maxTokensPerPerson: val ? +val : null,
									})
							"
							@blur="$v.smartContractBuilder.maxTokensPerPerson.$touch()"
							:state="
								validateState('smartContractBuilder.maxTokensPerPerson')
							"></b-form-input>
