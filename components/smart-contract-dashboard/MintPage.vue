                ...
                <b-card-body class="pb-1">
                  ...
                  <b-form-group label="Mint Count Selector">
                    <b-form-select
                      ...
                      :options="mintCountSelectorOptions"
                    ></b-form-select>
                  </b-form-group>
                  ...
                  <b-form-group :label="`Window Height (${site.windowHeight}px)`">
                    <b-form-input
                  ...
                  <b-form-group label="Minted Counter" label-cols="9" content-cols="3">
                    <b-form-checkbox
                      id="isCounterHidden"
                ...
                <b-card-body class="pb-1">
                  ...
                  <b-form-group :label="`Width (${stylesConfig.mintBtnWidth})`">
                    <b-form-input
                      type="range"
                      max="100"
                      :value="stylesConfig.mintBtnWidth.toString().replace('%', '')"
                      @change="(val) => (stylesConfig.mintBtnWidth = `${val}%`)"
                    ></b-form-input>
                  </b-form-group>
                </b-card-body>
              </b-collapse>
